// old version of app.js before i decided to switch into using 2 scripts
 ...
 */
 ...
 var redirect_uri ='http://192.168.0.18:80/callback'
 /**
 ...
 app.get('/login', function(req, res) {
   ...
   if (typeof(req.query["name"]) != "undefined"){
     ...
     var scope = 'user-read-private user-read-email user-top-read user-library-read playlist-modify-private streaming';
